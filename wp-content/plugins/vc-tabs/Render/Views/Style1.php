...
class Style1 extends Render {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo '      <div class=" oxi-tabs-body-' . $this->oxiid . ' oxi-tabs-body-tabs animate__animated ' . ($this->admin == 'admin' ? 'oxi-addons-admin-edit-list' : '') . '" id="oxi-tabs-body-' . $this->oxiid . '-' . $number . '">
