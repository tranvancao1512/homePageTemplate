...
class Style3 extends Helper {
    ...
    public function register_header_general() {
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} > .oxi-tabs-ultimate-style > .oxi-tabs-ultimate-header-wrap .oxi-tabs-header-li' => 'left:{{SIZE}}{{UNIT}};top:{{SIZE}}{{UNIT}};right:{{SIZE}}{{UNIT}};bottom:{{SIZE}}{{UNIT}};',
            ],
        ...
        $this->add_group_control(
                ...
                [
                    ...
                    'type' => Controls::SINGLEBORDER,
                    'selector' => [
                        '{{WRAPPER}}  > .oxi-tabs-ultimate-style > .oxi-tabs-ultimate-header-wrap .oxi-tabs-header-li.active' => 'border: {{SIZE}}px {{TYPE}} {{COLOR}};'
                    ],
                    'description' => 'Customize Single Border of the Header. Set Type, Size, and Color.',
                ]
        );
