	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <tfoot>
	    	<tr>
				...
				<a href="https://www.wponlinesupport.com/pricing/?utm_source=WP&utm_medium=Slickslider&utm_campaign=Upgrade-PRO" target="_blank"><?php _e( 'View Buying Options', 'wp-slick-slider-and-image-carousel' ); ?></a></td>
	    	</tr>
	    </tfoot>
	   <tbody>
			<tr>
